...
import { prepareRunChecher } from "../../../lib/shared/util.js";


const {shouldRun} = prepareRunChecher({timerDelay: 500})
...
export default class Service {
    ...
    async loadModel() {
        this.#model = await this.#faceLandmarksDetection.load(this.#faceLandmarksDetection.SupportedPackages.mediapipeFacemesh,
                {maxFaces: 1}
            )
    }
